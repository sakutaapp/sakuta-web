<template>
    <Container class="mt-5">
        <div class="flex flex-col md:flex-row mb-5 md:space-x-3 space-y-2 md:space-y-0">
            <input v-model="filters.query" type="text" class="bg-dark-800 px-3 py-1 rounded focus:bg-dark-700 focus:outline-none focus:rounded-lg transition duration-250 w-full flex-grow" :placeholder="$t('search.placeholder')" />
            <div class="flex space-x-3 justify-between md:justify-end w-full">
                <div class="flex space-x-3">
                    <select class="bg-dark-800 focus:outline-none rounded transition duration-250 focus:bg-dark-700 pr-8" v-model="filters.type">
                    ...
                    <select class="bg-dark-800 focus:outline-none rounded transition duration-250 focus:bg-dark-700 pr-8" v-model="filters.sort">
                ...
                <a :href="`/search?${filterQuery}`">
                    <div class="bg-dark-800 hover:bg-dark-700 transition duration-100 h-8 w-8 rounded-full flex justify-center items-center">
                        <svg class="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
                    </div>
                </a>
            </div>
        </div>
