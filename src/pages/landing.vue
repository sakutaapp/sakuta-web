<template>
    <div>
        ...
        <Container>
            ...
            <p class="text-center text-gray-500 text-sm mt-5" v-html="$t('landing.iconCredits', { icons8: '<a target=\'_blank\' href=\'https://icons8.com/\' class=\'underline hover:text-primary transition duration-100\'>Icons8</a>' })" />
        </Container>
    </div>
</template>
