        ...
        <Container>
            <div class="flex items-center">
                ...
                <div class="flex-grow w-1/6 flex justify-end space-x-3">
                    ...
                    <svg class="w-6 h-6 block md:hidden" @click="sidebar = true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
                </div>
            </div>
        </Container>
        <NavSidebar v-if="sidebar" :links="nav" @close="sidebar = false" />
    </div>
</template>
