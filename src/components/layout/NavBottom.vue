<template>
    <div class="fixed w-full bottom-0 left-0 flex md:hidden z-1 bg-gray-800 dark:bg-dark-800 flex justify-around items-center py-3 z-100 text-white">
        ...
        <nuxt-link to="/search" class="opacity-40 nav-bottom-link">
        ...
        <svg class="h-10 w-10 bg-primary rounded-xl p-1.5" @click="$emit('toggle-command-menu')" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3H6a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3V6a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 3 3 0 0 0-3-3z"></path></svg>

        <svg class="h-8 w-8 opacity-40" @click="$emit('settings')" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg class="h-8 w-8 opacity-40" @click="wipPopup()" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<style>
.nav-bottom-link.nuxt-link-active {
    opacity: 1 !important;
}
</style>
